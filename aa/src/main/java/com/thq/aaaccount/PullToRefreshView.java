...
import com.thq.aaaccount.refresh_view.BaseRefreshView;
import com.thq.aaaccount.refresh_view.SunRefreshView;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public boolean onTouchEvent(@NonNull MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mListener != null) {
                    //added by hongqi
                    mListener.onCurrentDragPercent(mCurrentDragPercent);
                }
    ...
    public interface OnRefreshListener {
        void onRefresh();
        void onCurrentDragPercent(float percent);
        void onCancel();
    }
